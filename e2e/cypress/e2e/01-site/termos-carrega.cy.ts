...
//   Cenario: A pagina de termos carrega corretamente
//     Dado que um visitante abre a pagina de termos
...
describe('Website publico', () => {
  it('a página de termos carrega com título, cabeçalho e descrição sem erros', () => {
    const errors: string[] = [];
