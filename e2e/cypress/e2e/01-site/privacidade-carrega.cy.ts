...
//   Cenario: A pagina de privacidade carrega corretamente
//     Dado que um visitante abre a pagina de privacidade
...
describe('Website publico', () => {
  it('a página de privacidade carrega com título, cabeçalho e descrição sem erros', () => {
    const errors: string[] = [];
