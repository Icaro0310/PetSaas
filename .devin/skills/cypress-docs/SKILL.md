...
- Versao em uso: Cypress 16.1.0 (`e2e/package.json`). Ao verificar docs, prefere
  sempre a documentacao da v16 (ex.: `Cypress.env()` removido -> `Cypress.expose()` /
  `cy.env()`; Electron deprecated como browser de teste).
